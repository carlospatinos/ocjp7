...
package com.kinettik.mx.sorting;
...
public class ArrayStructures {
    ...
    public boolean doesArrayContainThisValue(final int searchValue) {
    ...
    public void insertValue(final int value) {
        if (arraySize < 50) {
    ...
    public String linearSearchForValue(final int value) {
        boolean valueInArray = false;
    ...
    public void printHorzArray(final int i, final int j) {
        for (int n = 0; n < 51; n++) {
            System.out.print("-");
        }
        System.out.println();
    ...
    public void swapValues(final int indexOne, final int indexTwo) {
        final int temp = theArray[indexOne];
    ...
    public void binarySearchForValue(final int value) {
        int lowIndex = 0;
    ...
    public static void main(final String[] args) {
        final ArrayStructures newArray = new ArrayStructures();
